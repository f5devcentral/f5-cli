...
--------------------------------
The following are examples of how to create an authentication config for a authentication provider. Any commands that interact with BIG-IP or CLOUD SERVICES require that authentication to that BIG-IP is already configured. ::
...
--------------------------------
The following are examples of how to update a authentication accounts: ::
...
Toggling a default authentication account
-----------------------------------------
...
Disabling SSL Warnings thorough global config settings
------------------------------------------------------
